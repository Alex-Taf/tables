<template>
    <el-dialog title="Добавить нового пользователя" :visible.sync="isAddModalVisible" width="30%" :before-close="handleClose">
      <el-row :gutter="20" class="form-row">
        ...
        <el-col :span="19"><el-input placeholder="Имя" v-model="newUser.name" minlength="5" maxlength="30" show-word-limit clearable></el-input></el-col>
      </el-row>
      <el-row :gutter="20" class="form-row">
        <el-col :span="4"><label>Username</label></el-col>
        <el-col :span="19"><el-input placeholder="Username" v-model="newUser.username" minlength="5" maxlength="30" show-word-limit clearable></el-input></el-col>
      </el-row>
      <el-row :gutter="20" class="form-row">
        <el-col :span="4"><label>E-mail</label></el-col>
        <el-col :span="19"><el-input placeholder="E-mail" v-model="newUser.email" minlength="5" maxlength="30" show-word-limit clearable></el-input></el-col>
      </el-row>
      <el-row :gutter="20" class="form-row">
        <el-col :span="4"><label>Телефон</label></el-col>
        <el-col :span="19"><el-input placeholder="Телефон" v-model="newUser.phone" minlength="5" maxlength="30" show-word-limit clearable></el-input></el-col>
      </el-row>
